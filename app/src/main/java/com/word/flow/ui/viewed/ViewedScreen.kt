...
fun ViewedScreen(
    ...
    vm: ViewedViewModel = hiltViewModel(),
) {
    ...
    Column(
        ...
        if (!haveAnyWords) {
            Box(
                ...
                Text(
                    "No words found yet. Go to \"${AppRoute.Home.Swiping.title}\" to find new words.",
            ...
            if (!words.isEmpty()) {
                LazyColumn(
                    ...
                    contentPadding = PaddingValues(
                        bottom = LocalAppPadding.current.calculateBottomPadding()
                    ),
                    modifier = Modifier
                ...
                Box(
                    ...
                    Text(
                        "No ${if (state.isKnown) "known" else "unknown"} words yet.",
                        style = MaterialTheme.typography.titleMedium,
                        textAlign = TextAlign.Center,
                    )
                }
